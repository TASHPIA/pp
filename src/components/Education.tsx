  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10 text-left">
        ...
        {/* Timeline Layout */}
        <div className="relative border-l-2 border-slate-150 dark:border-slate-800 ml-4 md:ml-12 pl-6 md:pl-10 space-y-12">
          ...
          <div className="relative">
            ...
            >
              <div className="flex flex-wrap items-center justify-between gap-4 mb-4">
                ...
                <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-white dark:bg-slate-900 text-[11px] font-mono text-slate-500 dark:text-slate-400 border border-slate-200 dark:border-slate-800">
