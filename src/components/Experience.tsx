  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 text-left">
        ...
        {/* Experience Cards responsive column block */}
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 flex flex-col justify-between">
                  ...
                  <div className="flex flex-wrap gap-1.5 mt-6 pt-4 border-t border-slate-100 dark:border-slate-850">
                    ...
                    {activity.skillsAcquired.map((skill) => (
                      <span
                        key={skill}
                        className="px-2.5 py-1 text-[9px] font-mono tracking-tight bg-slate-50 dark:bg-slate-900 text-slate-500 dark:text-slate-400 rounded-md border border-slate-200/50 dark:border-slate-805"
                      >
                        {skill}
                      </span>
                    ))}
